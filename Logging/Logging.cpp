...
static const char* toString(D3DRENDERSTATETYPE state)
{
	switch (state)
	{
	case D3DRS_ZENABLE:
...
std::ostream& operator<<(std::ostream& os, D3DRENDERSTATETYPE state)
{
	return os << toString(state);
}

static const char* toString(D3DTEXTURESTAGESTATETYPE state)
{
	switch (state)
	{
	case D3DTSS_COLOROP:
...
std::ostream& operator<<(std::ostream& os, D3DTEXTURESTAGESTATETYPE state)
{
	return os << toString(state);
}

static const char* toString(D3DSAMPLERSTATETYPE state)
{
	switch (state)
	{
...
std::ostream& operator<<(std::ostream& os, D3DSAMPLERSTATETYPE state)
{
	return os << toString(state);
}
